...
def render_locked_tiles_with_tooltips(surface, offset_x, offset_y, zoom, mouse_pos, tilemap, destroy_mode, selected_building):
    tooltip_data = None
            ...
            if region_data["locked"]:
                ...
                if hovering:
                    ...
                    for grid_x, grid_y in region_data["tiles"]:
                        tile_x = grid_x * tile_width + offset_x
                        tile_y = grid_y * tile_height + offset_y
                        highlight_overlay = pygame.Surface((tile_width, tile_height), pygame.SRCALPHA)
